  ...
  head: () => ({
    meta: [
      ...
      { title: "VibeCode Studio — OpenClaw-Native Website Builder" },
      {
        name: "description",
        content:
          "Vibe-code entire OpenClaw agent storefronts in natural language. Describe it, preview it, deploy it.",
      },
      { property: "og:title", content: "VibeCode Studio — Build OpenClaw Sites with AI" },
      {
        property: "og:description",
        content:
          "The official OpenClaw website studio. Ship agent storefronts in under 90 minutes.",
      },
        ...
        <div className="flex flex-col justify-center p-8 lg:p-14 border-r border-white/10 overflow-y-auto">
          <div className="mb-10">
            ...
            <p className="text-white/50 text-lg max-w-md">
              Describe your dream agent storefront. OpenClaw generates, previews, and deploys the
              full ClawSite repo — instantly.
            </p>
          </div>
          <ClawPlayground />
        </div>
